      ...
      <section className="pt-8 pb-16 md:py-24">
        <div className="container mx-auto px-4 lg:px-8">
          <div ref={containerRef} className="max-w-3xl mx-auto relative">
            {/* Grey spine */}
            <div className="absolute left-[5px] md:left-1/2 md:-translate-x-1/2 top-0 bottom-0 w-px bg-border" />
            {/* Scroll-driven red beam */}
            <motion.div
              style={{ height: beamHeight }}
              className="absolute left-[5px] md:left-1/2 md:-translate-x-1/2 top-0 w-px bg-primary origin-top z-[1]"
            />
            ...
            {milestones.map((m, i) => (
              <motion.div
                ...
                className={`relative pl-8 md:pl-0 mb-8 last:mb-0 md:flex md:items-start md:gap-0 ${
                  i % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"
                }`}
              >
                <div className="absolute left-0 md:left-1/2 md:-translate-x-1/2 top-1.5 z-10 w-[11px] h-[11px] rounded-full bg-primary border-2 border-background" />
